					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Có {{count($new_product)}} sản phẩm 1 trang</p>
						...
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">Có {{count($sale_product)}} sản phẩm 1 trang</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
								...
								<div class="col-sm-3">
									...
									<div class="ribbon-wrapper"><div class="ribbon sale">Sale</div></div>
										<div class="single-item-header">
											<a href="chi-tiet-san-pham/{{$sale->id}}"><img src="source/image/product/{{$sale->image}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="add-to-cart/{{$sale->id}}"><i class="fa fa-shopping-cart"></i></a>
											<a class="beta-btn primary" href="chi-tiet-san-pham/{{$sale->id}}">Details <i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
